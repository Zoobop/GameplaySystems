...
namespace DialogueSystem.Editor
{
    ...
    public class DSGraphView : GraphView
    {
        ...
        public DSNode CreateNode(string nodeName, DialogueType dialogueType, Vector2 position, bool shouldDraw = true)
        {
            Type nodeType = Type.GetType($"DialogueSystem.Editor.DS{dialogueType}Node");
